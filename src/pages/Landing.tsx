...
import { Heart, MessageCircle, Wind, BookOpen, ChevronUp, User, ArrowRight, Sparkles, HelpCircle, LogIn, Rocket, Crown, Check, Users, Phone } from "lucide-react";
...
const pricingPlans = [
  ...
  },
  {
    ...
    highlight: true,
    priceId: "price_1ShIZlAsrgxssNTVizMEk01u",
    popular: true,
  },
  {
    name: "Couples",
    ...
    highlight: false,
    priceId: "price_1ShIZnAsrgxssNTVh4alx0aM",
    popular: false,
  },
];
...
const slides: ReelSlide[] = [
  ...
  },
  {
    ...
    description: "Date nights with coloring books & recipes, relationship games, digital gifts, private chat, and shared mood tracking.",
  },
  {
    id: 8,
