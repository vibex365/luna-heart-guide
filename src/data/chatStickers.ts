...
export const stickerPacks: StickerPack[] = [
  ...
  },
  {
    ...
    stickers: [
      ...
      { id: "flirty-13", emoji: "👅", label: "Tongue" },
      { id: "flirty-14", emoji: "💦", label: "Sweat Droplets" },
      { id: "flirty-15", emoji: "🍆", label: "Eggplant" },
      { id: "flirty-16", emoji: "🥵", label: "Hot Face" },
      { id: "flirty-17", emoji: "😍", label: "Heart Eyes" },
      { id: "flirty-18", emoji: "🥴", label: "Woozy Face" },
      { id: "flirty-19", emoji: "😮‍💨", label: "Exhaling" },
      { id: "flirty-20", emoji: "🫦", label: "Biting Lip" },
    ],
  },
];
